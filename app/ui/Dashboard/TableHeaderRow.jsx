...
export default function TableHeaderRow({ zIndex }) {
  ...
  return (
    ...
    >
      ...
      <li
        className={`flex rounded-tl-md border border-l-[6px] ${"border-l-green-800"} sticky left-10 min-w-[24rem] bg-white ${zIndex}`}
      >
