    ...
    <div className="tables-container h-[calc(100vh-25rem)]">
      <div className="main-table">
        <div className="sprint-table">
          <ul className="table-head text-sm rounded-tl-md flex h-8 sticky top-[12.2rem] z-30 bg-white">
          ...
          {tasks.map((task, index) => (
            <ul
              key={index}
              className="group/row relative text-sm flex h-8 *:hover:bg-hoverItem cursor-pointer"
            >
          ...
          <ul className="tab-row text-sm h-8 flex hover:bg-hoverItem border-b bg-white">
            <li className="bg-white min-w-10 sticky left-0 top-10 z-20 -mt-1 h-9"></li>
          ...
          {/* table footer */}
          <ul className="tab-footer flex h-8">
            <li className="bg-white h-full min-w-10 sticky left-0 top-10 z-20"></li>
